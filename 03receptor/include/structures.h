 ...
 *  - is_valid: 0 = vacío/libre, 1 = ocupado con dato encriptado.
 ...
 *    Los datos dinámicos van al final del segmento en este orden:
...
typedef struct {
    ...
    // (Compatibilidad) índices de semáforos legacy
